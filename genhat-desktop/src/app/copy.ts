...
export const COPY = {
  ...
  modePrivateTooltip:
    "Private mode: models run entirely on this device. Nothing you type is sent to the internet for answers.",
  modeCloudLabel: "Cloud",
  modeCloudSub: "Uses the internet",
  modeCloudTooltip:
    "Cloud mode: answers are generated by NELA Cloud models over the internet. Switching intelligence tiers won\u2019t download anything.",
