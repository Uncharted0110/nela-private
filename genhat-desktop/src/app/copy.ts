...
export const COPY = {
  ...
  modePrivateTooltip:
    "Private mode: models run entirely on this device. Nothing you type is sent to NELA Cloud for answers.",
  modeCloudLabel: "Cloud",
  modeCloudSub: "Uses the internet",
  modeCloudTooltip:
    "Cloud mode: answers are generated by NELA Cloud over the internet (Fast / Smart / Deep). Prompts and chat attachments you send in Cloud leave this device.",
  modeToggleAria: "Switch between Private (on device) and Cloud (internet)",
  modeCloudSetup: "Set up",
  modeCloudSetupTooltip:
    "Cloud mode needs you to sign in and pick a plan. Click to open NELA Cloud settings.",
  modeWebOn: "Web on",
