...
; 5b. FileIndexer folder selection (Default / Custom / Confirm)
; Functions come from installerHooks (nsis/preinstall.nsh).
; Do not set MUI_PAGE_CUSTOMFUNCTION_PRE here — that define is for MUI pages only
; and must not be redefined. Passive/silent skips are handled inside the page functions.
